...
```bash
cd 03.outbox
chmod +x script/test-00-create-outbox-event.sh
./script/test-00-create-outbox-event.sh
```
...
```bash
cd 03.outbox
chmod +x script/test-01-insert-outbox-event.sh
./script/test-01-insert-outbox-event.sh
```
...
```bash
chmod +x script/test-02-check-kafka-topic.sh
./script/test-02-check-kafka-topic.sh
```
...
```bash
chmod +x script/test-03-test-consumer.sh
./script/test-03-test-consumer.sh
```
